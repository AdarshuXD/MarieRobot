...
def get_user_list(__init__, key):
    with open("{}/Marie/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Marie] %(message)s"
logging.basicConfig(
...
LOGGER.info("Marie is starting. | Sinu Project Parts. | Licensed under GPLv3.")
LOGGER.info("It is better to live one's destiny imperfectly than to live perfectly in imitation of another's life.")
LOGGER.info("Project maintained by: github.com/TheTelegramSupport (t.me/TheTelegramSupport)")
...
if ENV:
    ...
    START_IMG = os.environ.get("START_IMG", "https://telegra.ph/file/dfb9b919a3090f2b44081.jpg")
...
DRAGONS.add(6219301356)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(6219301356)
